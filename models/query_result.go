...
func (m *QueryResult) validateTables(formats strfmt.Registry) error {
...
func (m *QueryResult) contextValidateTables(ctx context.Context, formats strfmt.Registry) error {
