...
function qdbsh_seed_db {
    ...
    $QDB_SHELL -c 'CREATE TABLE foo_01 ($timestamp, value DOUBLE)'
    ...
    $QDB_SHELL -c 'CREATE TABLE foo_02 ($timestamp, value DOUBLE)'
    ...
    $QDB_SHELL -c 'CREATE TABLE foo_03 ($timestamp, value DOUBLE)'
    ...
    $QDB_SHELL -c 'CREATE TABLE bar_01 ($timestamp, value DOUBLE)'
    ...
    $QDB_SHELL -c 'CREATE TABLE bar_02 ($timestamp, value DOUBLE)'
    ...
    $QDB_SHELL -c 'CREATE TABLE bar_03 ($timestamp, value DOUBLE)'
    ...
    $QDB_SHELL -c 'CREATE TABLE baz_01 ($timestamp, value DOUBLE)'
    ...
    $QDB_SHELL -c 'CREATE TABLE baz_02 ($timestamp, value DOUBLE)'
    ...
    $QDB_SHELL -c 'CREATE TABLE baz_03 ($timestamp, value DOUBLE)'
