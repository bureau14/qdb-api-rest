...
func (o *GetMaxInBufferSizeURL) Build() (*url.URL, error) {
	...
	var _path = "/option/max-in-buffer-size"
...
func (o *GetMaxInBufferSizeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetMaxInBufferSizeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetMaxInBufferSizeURL")
	}
