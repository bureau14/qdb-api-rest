...
func (o *MaxInBufferSizeURL) Build() (*url.URL, error) {
	...
	var _path = "/option/get-max-in-buffer-size"
...
func (o *MaxInBufferSizeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on MaxInBufferSizeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on MaxInBufferSizeURL")
	}
