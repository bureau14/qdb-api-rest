...
func NewGetMaxInBufferSizeParams() GetMaxInBufferSizeParams {
	...
	return GetMaxInBufferSizeParams{}
}

// GetMaxInBufferSizeParams contains all the bound params for the get max in buffer size operation
...
func (o *GetMaxInBufferSizeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
